              ...
              <div className="content bg-white py-3 rounded-3 mt-0">
                <div className="row">
                  ...
                  <div className="col-12 bgColorLite p-4 textMain my-3 ">
                    <p className='m-0 fs-5'>{doctorDay} - <span className='text-capitalize'>{doctorTimeStart}</span> <span className='text-capitalize'>{doctorTimeEnd}</span> <span className='fw-bold'> first-come , required Reservation , first-served</span></p>
                  </div>
                </div>
              </div>
            </div>
