...
import SearchInputsRight from './../mainSlide/searchInputsRightMain(Telehealth)/SearchInputsRight';
import './DoctorsDataOnTelehealth.css'

export default function DoctorsDataOnTelehealth() {
